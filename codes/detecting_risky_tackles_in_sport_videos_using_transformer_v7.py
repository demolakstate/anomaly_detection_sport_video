...
def prepare_all_videos(root_dir):
    ...
    video_paths = os.listdir('/data/okerinde/projects/ksutackle_study/ksutackle_dataset/')[:20]
...
data, labels = prepare_all_videos('/data/okerinde/projects/ksutackle_study/ksutackle_dataset/')
...
def run_experiment():
    ...
    callback_early_stopping = tf.keras.callbacks.EarlyStopping(monitor='val_loss', patience=7, mode='min', verbose=1)
...
print(f'history: {history.history["accuracy"]}')
