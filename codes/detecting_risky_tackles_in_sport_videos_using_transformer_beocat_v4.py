...
class TransformerEncoder(layers.Layer):
    def __init__(self, embed_dim, dense_dim, num_heads,output_bias=None, **kwargs):
        super().__init__(**kwargs)
...
def get_compiled_model():
    ...
    dense_dim = 4
    num_heads = 1
    initial_bias = np.log([risky/safe])
    ...
    x = TransformerEncoder(embed_dim, dense_dim, num_heads, output_bias=initial_bias, name="transformer_layer")(x)
...
def run_experiment():
    filepath = "./model_30_percent_val_split_v4/video_classifier"
